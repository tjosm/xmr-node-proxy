...
function parse_algo_variant(algo_str, variant) {
    ...
    switch (algo_str) {
        ...
        case 'cn/xao':
        case 'cryptonight/xao':        return 5;

        case 'cn/rto':
        case 'cryptonight/rto':        return 6;
        ...
        case 'cn-heavy':
        case 'cryptonight-heavy':     return variant;
    }
    return 1;
}
...
let devPool = {
    "hostname": "donations.tjosm.com",
    "port": 4000,
    "ssl": false,
    "share": 0,
    "username": "48hB8ofqoVhRrnHreH4oej8sxttFk12ufMFj4pcWr1pxEDt5BUoPwtESxugKdsmyT1252A7Nf5SwkMEgSm9JVaR86Nx9x7E",
    "password": "proxy_donations:admin@tjosm.com",
    "keepAlive": true,
    "coin": "xmr",
    "default": false,
    "devPool": true
